...
CREATE TABLE attribute (id UUID PRIMARY KEY DEFAULT gen_random_uuid(), category_slug VARCHAR(32) REFERENCES category(slug) ON DELETE CASCADE, data jsonb, UNIQUE (id));
